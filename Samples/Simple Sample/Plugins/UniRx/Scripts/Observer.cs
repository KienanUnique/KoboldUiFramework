...
namespace SampleUnirx
{
    public static class Observer
    {
        ...
        {
            return Create<T>(onNext, SampleUnirx.Stubs.Throw, SampleUnirx.Stubs.Nop);
        }

        public static IObserver<T> Create<T>(Action<T> onNext, Action<Exception> onError)
        {
            return Create<T>(onNext, onError, SampleUnirx.Stubs.Nop);
        }

        public static IObserver<T> Create<T>(Action<T> onNext, Action onCompleted)
        {
            return Create<T>(onNext, SampleUnirx.Stubs.Throw, onCompleted);
        }
        ...
        class AutoDetachObserver<T> : SampleUnirx.Operators.OperatorObserverBase<T, T>
        {
    ...
    public static partial class ObserverExtensions
    {
        ...
        {
            return new SampleUnirx.Operators.SynchronizedObserver<T>(observer, new object());
        }

        public static IObserver<T> Synchronize<T>(this IObserver<T> observer, object gate)
        {
            return new SampleUnirx.Operators.SynchronizedObserver<T>(observer, gate);
        }
    }
    ...
    public static partial class ObservableExtensions
    {
        ...
        {
            return source.Subscribe(SampleUnirx.InternalUtil.ThrowObserver<T>.Instance);
        }

        public static IDisposable Subscribe<T>(this IObservable<T> source, Action<T> isInAnimation)
        {
            return source.Subscribe(Observer.CreateSubscribeObserver(isInAnimation, Stubs.Throw, Stubs.Nop));
        }
