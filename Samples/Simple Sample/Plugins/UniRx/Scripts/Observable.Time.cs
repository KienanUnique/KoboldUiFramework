...
namespace SampleUnirx
{
    ...
    public static partial class Observable
    {
        ...
        public static IObservable<SampleUnirx.TimeInterval<TSource>> TimeInterval<TSource>(this IObservable<TSource> source)
        {
            return TimeInterval(source, Scheduler.DefaultSchedulers.TimeBasedOperations);
        }

        public static IObservable<SampleUnirx.TimeInterval<TSource>> TimeInterval<TSource>(this IObservable<TSource> source, IScheduler scheduler)
        {
            return new SampleUnirx.Operators.TimeIntervalObservable<TSource>(source, scheduler);
        }
