...
using SampleUnirx.InternalUtil;
using SampleUnirx.Triggers;
using UnityEngine;
using System.Threading;

#if !UniRxLibrary
using SchedulerUnity = SampleUnirx.Scheduler;
#endif
...
#pragma warning restore CS0618
        ...
        {
            return new SampleUnirx.Operators.FromCoroutineObservable<T>(coroutine);
        }
        ...
        {
            return new SampleUnirx.Operators.FromMicroCoroutineObservable<T>(coroutine, frameCountType);
        }
        ...
        public static IObservable<T> DelayFrame<T>(this IObservable<T> source, int frameCount, FrameCountType frameCountType = FrameCountType.Update)
        {
            ...
            return new SampleUnirx.Operators.DelayFrameObservable<T>(source, frameCount, frameCountType);
        }

        public static IObservable<T> Sample<T, T2>(this IObservable<T> source, IObservable<T2> sampler)
        {
            return new SampleUnirx.Operators.SampleObservable<T, T2>(source, sampler);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new SampleUnirx.Operators.SampleFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new SampleUnirx.Operators.ThrottleFrameObservable<TSource>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new SampleUnirx.Operators.ThrottleFirstFrameObservable<TSource>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new SampleUnirx.Operators.TimeoutFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new SampleUnirx.Operators.DelayFrameSubscriptionObservable<T>(source, frameCount, frameCountType);
        }
        ...
        //        case MainThreadDispatchType.FixedUpdate:
        //            return new SampleUnirx.Operators.SubscribeOnMainThreadObservable<T>(source, EveryFixedUpdate().Take(1));
        //        case MainThreadDispatchType.EndOfFrame:
        //            return new SampleUnirx.Operators.SubscribeOnMainThreadObservable<T>(source, EveryEndOfFrame().Take(1));
        //        case MainThreadDispatchType.GameObjectUpdate:
        //            return new SampleUnirx.Operators.SubscribeOnMainThreadObservable<T>(source, MainThreadDispatcher.UpdateAsObservable().Select(_ => 0L).Take(1));
        //        case MainThreadDispatchType.LateUpdate:
        //            return new SampleUnirx.Operators.SubscribeOnMainThreadObservable<T>(source, MainThreadDispatcher.LateUpdateAsObservable().Select(_ => 0L).Take(1));
        //        case MainThreadDispatchType.AfterUpdate:
        //            return new SampleUnirx.Operators.SubscribeOnMainThreadObservable<T>(source, EveryAfterUpdate().Take(1));
        //        default:
        //            throw new ArgumentException("type is invalid");
        //    }
        //}
        ...
        {
            return new SampleUnirx.Operators.RepeatUntilObservable<T>(sources, trigger, lifeTimeChecker);
        }

        public static IObservable<SampleUnirx.FrameInterval<T>> FrameInterval<T>(this IObservable<T> source)
        {
            return new SampleUnirx.Operators.FrameIntervalObservable<T>(source);
        }

        public static IObservable<SampleUnirx.TimeInterval<T>> FrameTimeInterval<T>(this IObservable<T> source, bool ignoreTimeScale = false)
        {
            return new SampleUnirx.Operators.FrameTimeIntervalObservable<T>(source, ignoreTimeScale);
        }
        ...
        public static IObservable<IList<T>> BatchFrame<T>(this IObservable<T> source, int frameCount, FrameCountType frameCountType)
        {
            ...
            return new SampleUnirx.Operators.BatchFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentException("frameCount must be >= 0, frameCount:" + frameCount);
            return new SampleUnirx.Operators.BatchFrameObservable(source, frameCount, frameCountType);
        }
