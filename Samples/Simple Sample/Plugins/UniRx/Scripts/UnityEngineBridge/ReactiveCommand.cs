...
namespace SampleUnirx
{
    ...
    {
        SampleUnirx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>> asyncActions = SampleUnirx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>>.Empty;
        ...
        public void Dispose()
        {
            ...
            IsDisposed = true;
            asyncActions = SampleUnirx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>>.Empty;
        }
