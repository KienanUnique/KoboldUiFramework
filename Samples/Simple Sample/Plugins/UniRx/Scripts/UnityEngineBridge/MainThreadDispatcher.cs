        ...
        public static void Initialize()
        {
            if (!initialized)
            {
                ...
                catch
                {
                    ...
                    var ex = new Exception("SampleUnirx requires a MainThreadDispatcher component created on the main thread. Make sure it is added to the scene before calling SampleUnirx from a worker thread.");
